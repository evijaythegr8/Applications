...
class TC_AD_Bluetooth_8_08_PBAP_Pull_Phonebook_Size_Information_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_PBD_BV_02_C'
       ...
       # Empty notifications list
        ...
        # Start PTS test case
        BluetoothDialogInput('Press OK and then start test case TC_PSE_PBD_BV_02_C in PTS ')
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_08_PBAP_Pull_Phonebook_Size_Information_All_1("TC_AD_Bluetooth_8_08_PBAP_Pull_Phonebook_Size_Information_All_1", duts)
        tc.run()
