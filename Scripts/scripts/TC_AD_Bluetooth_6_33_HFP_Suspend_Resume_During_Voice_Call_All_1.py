...
class TC_AD_Bluetooth_6_33_HFP_Suspend_Resume_During_Voice_Call_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_33_HFP_Suspend_Resume_During_Voice_Call_All_1("TC_AD_Bluetooth_6_33_HFP_Suspend_Resume_During_Voice_Call_All_1", duts)
        tc.run()
