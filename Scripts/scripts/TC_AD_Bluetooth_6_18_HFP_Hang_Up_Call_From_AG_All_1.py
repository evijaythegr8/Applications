...
class TC_AD_Bluetooth_6_18_HFP_Hang_Up_Call_From_AG_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        self.SendCommand(ComponentOne, OpCodes.END_CALL, message=number)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_18_HFP_Hang_Up_Call_From_AG_All_1("TC_AD_Bluetooth_6_18_HFP_Hang_Up_Call_From_AG_All_1", duts)
        tc.run()
