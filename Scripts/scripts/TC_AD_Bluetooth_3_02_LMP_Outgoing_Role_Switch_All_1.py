...
class TC_AD_Bluetooth_3_02_LMP_Outgoing_Role_Switch_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Switch role
        self.log.info("------ Running Shell Command Start ------")
        outData = self.RunShellCommandAndHciDump(ComponentOne, 'hcitool sr %s slave'%deviceTwoAddress)
        ...
        #Switch role
        self.log.info("------ Running Shell Command Start ------")
        outData = self.RunShellCommandAndHciDump(ComponentOne, 'hcitool sr %s master'%deviceTwoAddress)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_3_02_LMP_Outgoing_Role_Switch_All_1("TC_AD_Bluetooth_3_02_LMP_Outgoing_Role_Switch_All_1", duts)
        tc.run()
