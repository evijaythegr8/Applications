...
class TC_AD_Bluetooth_9_13_SPP_Data_Transfer_Data_Transferred_Correctly_Server_To_Client_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        time.sleep(1)
        self.SendAndWaitForEvent(ComponentOne, OpCodes.DATA_PUMP_SERVER, OpCodes.DATA_PUMP_SERVER, message='%s;%s;%s'%(serverId, (nbrOfKbToSend*1024), bufferSize), timeout=500)
        time.sleep(5)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_9_13_SPP_Data_Transfer_Data_Transferred_Correctly_Server_To_Client_All_1("TC_AD_Bluetooth_9_13_SPP_Data_Transfer_Data_Transferred_Correctly_Server_To_Client_All_1", duts)
        tc.run()
