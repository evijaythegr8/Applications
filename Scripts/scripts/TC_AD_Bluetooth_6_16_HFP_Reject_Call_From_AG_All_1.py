...
class TC_AD_Bluetooth_6_16_HFP_Reject_Call_From_AG_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_16_HFP_Reject_Call_From_AG_All_1("TC_AD_Bluetooth_6_16_HFP_Reject_Call_From_AG_All_1", duts)
        tc.run()
