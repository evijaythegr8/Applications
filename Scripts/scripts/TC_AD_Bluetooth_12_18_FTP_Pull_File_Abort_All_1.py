...
class TC_AD_Bluetooth_12_18_FTP_Pull_File_Abort_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_SERVER_OTR_BV_12_I'
        ...
        self.RunShellCommand(ComponentOne, 'dd if=/dev/zero of=/sdcard/FTPABORT.txt count=100000')
        time.sleep(20)
        ...
        #Clean up file
        self.RunShellCommand(ComponentOne, 'rm /sdcard/FTPABORT.txt')
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_12_18_FTP_Pull_File_Abort_All_1("TC_AD_Bluetooth_12_18_FTP_Pull_File_Abort_All_1", duts)
        tc.run()
