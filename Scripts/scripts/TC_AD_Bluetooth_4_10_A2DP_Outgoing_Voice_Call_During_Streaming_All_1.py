...
class TC_AD_Bluetooth_4_10_A2DP_Outgoing_Voice_Call_During_Streaming_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        time.sleep(2)
        BluetoothDialogInput("Verify that music is paused and that call in progress can be heard in the headset", option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_10_A2DP_Outgoing_Voice_Call_During_Streaming_All_1("TC_AD_Bluetooth_4_10_A2DP_Outgoing_Voice_Call_During_Streaming_All_1", duts)
        tc.run()
