...
class TC_AD_Bluetooth_10_08_SAP_Server_Power_SIM_Off_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTS_TC='TC_SERVER_POF_BV_01_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_10_08_SAP_Server_Power_SIM_Off_All_1("TC_AD_Bluetooth_10_08_SAP_Server_Power_SIM_Off_All_1", duts)
        tc.run()
