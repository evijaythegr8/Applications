...
class TC_AD_Bluetooth_4_22_A2DP_Suspend_Resume_During_Streaming_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_22_A2DP_Suspend_Resume_During_Streaming_All_1("TC_AD_Bluetooth_4_22_A2DP_Suspend_Resume_During_Streaming_All_1", duts)
        tc.run()
