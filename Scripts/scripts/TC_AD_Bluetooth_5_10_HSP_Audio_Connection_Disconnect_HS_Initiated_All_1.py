...
class TC_AD_Bluetooth_5_10_HSP_Audio_Connection_Disconnect_HS_Initiated_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ComponentTwo = '2'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'HSP_TC_AG_ACR_BV_01_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_5_10_HSP_Audio_Connection_Disconnect_HS_Initiated_All_1("TC_AD_Bluetooth_5_10_HSP_Audio_Connection_Disconnect_HS_Initiated_All_1", duts)
        tc.run()
