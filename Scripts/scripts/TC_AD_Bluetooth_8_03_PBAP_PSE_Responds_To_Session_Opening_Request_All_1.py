...
class TC_AD_Bluetooth_8_03_PBAP_PSE_Responds_To_Session_Opening_Request_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_SSM_BV_03_C'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_03_PBAP_PSE_Responds_To_Session_Opening_Request_All_1("TC_AD_Bluetooth_8_03_PBAP_PSE_Responds_To_Session_Opening_Request_All_1", duts)
        tc.run()
