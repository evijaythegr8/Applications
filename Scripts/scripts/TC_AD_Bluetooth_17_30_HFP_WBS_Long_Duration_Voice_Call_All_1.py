...
class TC_AD_Bluetooth_17_30_HFP_WBS_Long_Duration_Voice_Call_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        for i in range(0,duration/interval):
            ...
            print "Time: %s of %s"%(i*interval, duration)
        ...
        BluetoothDialogInput("Verify that the call is still working properly. Yes/No", option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_30_HFP_WBS_Long_Duration_Voice_Call_All_1("TC_AD_Bluetooth_17_30_HFP_WBS_Long_Duration_Voice_Call_All_1", duts)
        tc.run()
