...
class TC_AD_Bluetooth_1_40_GAP_Device_Discovery_During_Idle_Link_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_40_GAP_Device_Discovery_During_Idle_Link_All_1("TC_AD_Bluetooth_1_40_GAP_Device_Discovery_During_Idle_Link_All_1", duts)
        tc.run()
