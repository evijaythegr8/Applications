...
class TC_AD_Bluetooth_17_05_HFP_WBS_Outgoing_Voice_Call_While_Connected_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_05_HFP_WBS_Outgoing_Voice_Call_While_Connected_All_1("TC_AD_Bluetooth_17_05_HFP_WBS_Outgoing_Voice_Call_While_Connected_All_1", duts)
        tc.run()
