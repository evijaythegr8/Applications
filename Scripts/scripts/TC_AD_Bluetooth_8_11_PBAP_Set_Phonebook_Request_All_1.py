...
class TC_AD_Bluetooth_8_11_PBAP_Set_Phonebook_Request_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_PBB_BV_06_C'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_11_PBAP_Set_Phonebook_Request_All_1("TC_AD_Bluetooth_8_11_PBAP_Set_Phonebook_Request_All_1", duts)
        tc.run()
