...
class TC_AD_Bluetooth_7_22_OPP_Incoming_Transfer_Throughput_Measurement_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_22_OPP_Incoming_Transfer_Throughput_Measurement_All_1("TC_AD_Bluetooth_7_22_OPP_Incoming_Transfer_Throughput_Measurement_All_1", duts)
        tc.run()
