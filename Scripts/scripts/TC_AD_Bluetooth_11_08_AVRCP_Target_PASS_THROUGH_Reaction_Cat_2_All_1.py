...
class TC_AD_Bluetooth_11_08_AVRCP_Target_PASS_THROUGH_Reaction_Cat_2_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase='TC_TG_PTT_BV_02'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_08_AVRCP_Target_PASS_THROUGH_Reaction_Cat_2_All_1("TC_AD_Bluetooth_11_08_AVRCP_Target_PASS_THROUGH_Reaction_Cat_2_All_1", duts)
        tc.run()
