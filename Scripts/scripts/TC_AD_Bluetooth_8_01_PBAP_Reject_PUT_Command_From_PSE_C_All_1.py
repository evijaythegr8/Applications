...
class TC_AD_Bluetooth_8_01_PBAP_Reject_PUT_Command_From_PSE_C_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_SSM_BI_02_C'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_01_PBAP_Reject_PUT_Command_From_PSE_C_All_1("TC_AD_Bluetooth_8_01_PBAP_Reject_PUT_Command_From_PSE_C_All_1", duts)
        tc.run()
