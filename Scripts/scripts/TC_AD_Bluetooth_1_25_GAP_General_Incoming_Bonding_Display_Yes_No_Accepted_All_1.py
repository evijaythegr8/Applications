...
class TC_AD_Bluetooth_1_25_GAP_General_Incoming_Bonding_Display_Yes_No_Accepted_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        self.SendAndWaitForEvent(ComponentTwo, OpCodes.SET_PASSKEY, OpCodes.RFCOMM_CONNECT, message='%s;%s'%(deviceOneAddress,passkey))
        time.sleep(10)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_25_GAP_General_Incoming_Bonding_Display_Yes_No_Accepted_All_1("TC_AD_Bluetooth_1_25_GAP_General_Incoming_Bonding_Display_Yes_No_Accepted_All_1", duts)
        tc.run()
