...
class TC_AD_Bluetooth_3_09_LMP_Outgoing_Enter_Sniff_Subrate_Mode_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_3_09_LMP_Outgoing_Enter_Sniff_Subrate_Mode_All_1("TC_AD_Bluetooth_3_09_LMP_Outgoing_Enter_Sniff_Subrate_Mode_All_1", duts)
        tc.run()
