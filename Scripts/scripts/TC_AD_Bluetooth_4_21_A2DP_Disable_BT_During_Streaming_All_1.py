...
class TC_AD_Bluetooth_4_21_A2DP_Disable_BT_During_Streaming_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        self.WaitForEvent(ComponentOne, OpCodes.ACTION_ACL_CONNECTED, timeout=60)
        BluetoothDialogInput("Verify that the audio is routed back to the headset. Yes/No", option="TEST")
        time.sleep(5)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_21_A2DP_Disable_BT_During_Streaming_All_1("TC_AD_Bluetooth_4_21_A2DP_Disable_BT_During_Streaming_All_1", duts)
        tc.run()
