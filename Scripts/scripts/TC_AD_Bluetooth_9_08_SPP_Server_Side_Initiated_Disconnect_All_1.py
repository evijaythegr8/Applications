...
class TC_AD_Bluetooth_9_08_SPP_Server_Side_Initiated_Disconnect_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_9_08_SPP_Server_Side_Initiated_Disconnect_All_1("TC_AD_Bluetooth_9_08_SPP_Server_Side_Initiated_Disconnect_All_1", duts)
        tc.run()
