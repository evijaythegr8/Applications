...
class TC_AD_Bluetooth_7_02_OPP_Outgoing_Transfer_Single_Large_File_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_02_OPP_Outgoing_Transfer_Single_Large_File_All_1("TC_AD_Bluetooth_7_02_OPP_Outgoing_Transfer_Single_Large_File_All_1", duts)
        tc.run()
