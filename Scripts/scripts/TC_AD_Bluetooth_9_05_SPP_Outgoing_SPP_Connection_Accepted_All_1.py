...
class TC_AD_Bluetooth_9_05_SPP_Outgoing_SPP_Connection_Accepted_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_9_05_SPP_Outgoing_SPP_Connection_Accepted_All_1("TC_AD_Bluetooth_9_05_SPP_Outgoing_SPP_Connection_Accepted_All_1", duts)
        tc.run()
