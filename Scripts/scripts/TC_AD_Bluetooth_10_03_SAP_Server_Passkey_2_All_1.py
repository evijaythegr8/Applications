...
class TC_AD_Bluetooth_10_03_SAP_Server_Passkey_2_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTS_TC='TC_SERVER_CSU_BI_02_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_10_03_SAP_Server_Passkey_2_All_1("TC_AD_Bluetooth_10_03_SAP_Server_Passkey_2_All_1", duts)
        tc.run()
