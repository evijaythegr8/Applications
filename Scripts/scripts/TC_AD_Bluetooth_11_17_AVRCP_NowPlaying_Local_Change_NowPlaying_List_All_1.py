...
class TC_AD_Bluetooth_11_17_AVRCP_NowPlaying_Local_Change_NowPlaying_List_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase_1='TC_TG_CEC_BV_01'
        ptsTestCase_2='TC_TG_MCN_NP_BV_04_I'
        ...
        # Respond for the PTS query
        time.sleep(5)
        self.RunShellCommand(ComponentOne, command='./test-mediaplayer query NotifyNowPlayingChanged')
        time.sleep(10)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_17_AVRCP_NowPlaying_Local_Change_NowPlaying_List_All_1("TC_AD_Bluetooth_11_17_AVRCP_NowPlaying_Local_Change_NowPlaying_List_All_1", duts)
        tc.run()
