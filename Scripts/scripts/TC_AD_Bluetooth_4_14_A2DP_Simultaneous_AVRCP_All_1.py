...
class TC_AD_Bluetooth_4_14_A2DP_Simultaneous_AVRCP_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        # Verify that music is playing in the hands-free devices
        BluetoothDialogInput('Verify that audio can be heard in the hands-free device.. Yes/No',option='TEST')

        # Send AVRCP Pause from the hands-free device
        BluetoothDialogInput('Press Pause on the hands-free device. then press Enter')

        # Verify that the music is paused in the hands-free device
        BluetoothDialogInput('Verify that the music streaming is paused in the hands-free device. Yes/No',option='TEST')

        # Send AVRCP Play from the hands-free device
        BluetoothDialogInput('Press Play on the hands-free device. then press Enter')

        # Verify that the music is resumed in the hands-free device
        BluetoothDialogInput('Verify that the music is resumed in the hands-free device. then press Enter. Yes/No',option='TEST')
        time.sleep(5)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_14_A2DP_Simultaneous_AVRCP_All_1("TC_AD_Bluetooth_4_14_A2DP_Simultaneous_AVRCP_All_1", duts)
        tc.run()
