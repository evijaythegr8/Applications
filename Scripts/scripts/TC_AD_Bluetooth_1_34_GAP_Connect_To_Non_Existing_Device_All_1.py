...
class TC_AD_Bluetooth_1_34_GAP_Connect_To_Non_Existing_Device_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_34_GAP_Connect_To_Non_Existing_Device_All_1("TC_AD_Bluetooth_1_34_GAP_Connect_To_Non_Existing_Device_All_1", duts)
        tc.run()
