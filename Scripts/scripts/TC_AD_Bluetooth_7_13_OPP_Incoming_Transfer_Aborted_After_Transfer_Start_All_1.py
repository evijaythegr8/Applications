...
class TC_AD_Bluetooth_7_13_OPP_Incoming_Transfer_Aborted_After_Transfer_Start_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ComponentTwo = '2'
        image = 'pic_18.0_Mpix_NoName_3x2_Exif_2.21_BaselineStd_Q11.jpg'
        ...
        #Cancel transfer
        self.Wakeup(ComponentTwo, timeout=60)
        self.CancelOngoingTransfer(ComponentTwo)

        #Wait for transfer to finish
        time.sleep(40)

        # Verify that the file was not transfered OK
        result = self.RunShellCommand(ComponentOne, "sync;ls -l %s"%(targetPath))
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_13_OPP_Incoming_Transfer_Aborted_After_Transfer_Start_All_1("TC_AD_Bluetooth_7_13_OPP_Incoming_Transfer_Aborted_After_Transfer_Start_All_1", duts)
        tc.run()
