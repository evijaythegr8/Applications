...
class TC_AD_Bluetooth_17_09_HFP_WBS_Audio_Transfer_AG_Initiated_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput("Press Enter then in Phone Menu re-tick Bluetooth to transfer sound to headset")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_09_HFP_WBS_Audio_Transfer_AG_Initiated_All_1("TC_AD_Bluetooth_17_09_HFP_WBS_Audio_Transfer_AG_Initiated_All_1", duts)
        tc.run()
