...
class TC_AD_Bluetooth_11_20_AVRCP_Volume_Handling_Volume_Change_TG_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase_1='TC_TG_CEC_BV_01'
        ptsTestCase_2='TC_TG_VLH_BV_01_I'
        ...
        time.sleep(5)
        self.RunShellCommand(ComponentOne, command='./test-mediaplayer query NotifyVolumeChanged')
        time.sleep(10)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_20_AVRCP_Volume_Handling_Volume_Change_TG_All_1("TC_AD_Bluetooth_11_20_AVRCP_Volume_Handling_Volume_Change_TG_All_1", duts)
        tc.run()
