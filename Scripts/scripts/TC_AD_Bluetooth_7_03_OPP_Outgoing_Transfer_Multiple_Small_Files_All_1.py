...
class TC_AD_Bluetooth_7_03_OPP_Outgoing_Transfer_Multiple_Small_Files_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_03_OPP_Outgoing_Transfer_Multiple_Small_Files_All_1("TC_AD_Bluetooth_7_03_OPP_Outgoing_Transfer_Multiple_Small_Files_All_1", duts)
        tc.run()
