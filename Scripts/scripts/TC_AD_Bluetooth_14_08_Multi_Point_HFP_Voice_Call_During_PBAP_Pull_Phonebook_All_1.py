...
class TC_AD_Bluetooth_14_08_Multi_Point_HFP_Voice_Call_During_PBAP_Pull_Phonebook_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        ptsTestCase ='TC_PSE_PBB_BV_10_C'
        ...
        BluetoothDialogInput('Wait for PTS test case to finish then press Enter')
        time.sleep(1)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_14_08_Multi_Point_HFP_Voice_Call_During_PBAP_Pull_Phonebook_All_1("TC_AD_Bluetooth_14_08_Multi_Point_HFP_Voice_Call_During_PBAP_Pull_Phonebook_All_1", duts)
        tc.run()
