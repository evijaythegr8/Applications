...
class TC_AD_Bluetooth_6_19_HFP_Change_Volume_From_HF_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput("Using the headset change the volume up and down and verify that it changes. Yes/No", option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_19_HFP_Change_Volume_From_HF_All_1("TC_AD_Bluetooth_6_19_HFP_Change_Volume_From_HF_All_1", duts)
        tc.run()
