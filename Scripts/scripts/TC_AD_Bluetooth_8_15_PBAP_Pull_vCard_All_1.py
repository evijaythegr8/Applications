...
class TC_AD_Bluetooth_8_15_PBAP_Pull_vCard_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_15_PBAP_Pull_vCard_All_1("TC_AD_Bluetooth_8_15_PBAP_Pull_vCard_All_1", duts)
        tc.run()
