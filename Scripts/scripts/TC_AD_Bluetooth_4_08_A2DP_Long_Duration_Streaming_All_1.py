...
class TC_AD_Bluetooth_4_08_A2DP_Long_Duration_Streaming_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        duration = int(Session.getSetupFileParam('bt', 'a2dplongduration'))*60
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_08_A2DP_Long_Duration_Streaming_All_1("TC_AD_Bluetooth_4_08_A2DP_Long_Duration_Streaming_All_1", duts)
        tc.run()
