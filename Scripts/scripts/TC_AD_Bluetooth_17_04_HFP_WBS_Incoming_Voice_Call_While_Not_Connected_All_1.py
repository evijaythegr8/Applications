...
class TC_AD_Bluetooth_17_04_HFP_WBS_Incoming_Voice_Call_While_Not_Connected_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Disconnect Handsfree from sink
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_04_HFP_WBS_Incoming_Voice_Call_While_Not_Connected_All_1("TC_AD_Bluetooth_17_04_HFP_WBS_Incoming_Voice_Call_While_Not_Connected_All_1", duts)
        tc.run()
