...
class TC_AD_Bluetooth_11_03_AVRCP_Target_Connection_Release_Accept_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase='TC_TG_CRC_BV_01'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_03_AVRCP_Target_Connection_Release_Accept_All_1("TC_AD_Bluetooth_11_03_AVRCP_Target_Connection_Release_Accept_All_1", duts)
        tc.run()
