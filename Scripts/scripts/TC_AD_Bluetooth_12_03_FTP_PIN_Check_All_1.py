...
class TC_AD_Bluetooth_12_03_FTP_PIN_Check_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_SERVER_SSR_BV_03_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_12_03_FTP_PIN_Check_All_1("TC_AD_Bluetooth_12_03_FTP_PIN_Check_All_1", duts)
        tc.run()
