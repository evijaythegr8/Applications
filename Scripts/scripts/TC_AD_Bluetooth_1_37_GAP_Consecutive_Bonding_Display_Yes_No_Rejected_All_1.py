...
class TC_AD_Bluetooth_1_37_GAP_Consecutive_Bonding_Display_Yes_No_Rejected_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_37_GAP_Consecutive_Bonding_Display_Yes_No_Rejected_All_1("TC_AD_Bluetooth_1_37_GAP_Consecutive_Bonding_Display_Yes_No_Rejected_All_1", duts)
        tc.run()
