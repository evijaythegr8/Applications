...
class TC_AD_Bluetooth_2_10_SDAP_Server_Verify_Services_Active_Link_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Verify that data is still being sent
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_2_10_SDAP_Server_Verify_Services_Active_Link_All_1("TC_AD_Bluetooth_2_10_SDAP_Server_Verify_Services_Active_Link_All_1", duts)
        tc.run()
