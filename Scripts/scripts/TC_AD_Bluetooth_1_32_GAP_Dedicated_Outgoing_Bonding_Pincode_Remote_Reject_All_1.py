...
class TC_AD_Bluetooth_1_32_GAP_Dedicated_Outgoing_Bonding_Pincode_Remote_Reject_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput('Reject incoming pairing in remote device then press Enter')
        self.WaitForEvent(ComponentOne, OpCodes.UNBOND_REASON_AUTH_REJECTED, timeout=50)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_32_GAP_Dedicated_Outgoing_Bonding_Pincode_Remote_Reject_All_1("TC_AD_Bluetooth_1_32_GAP_Dedicated_Outgoing_Bonding_Pincode_Remote_Reject_All_1", duts)
        tc.run()
