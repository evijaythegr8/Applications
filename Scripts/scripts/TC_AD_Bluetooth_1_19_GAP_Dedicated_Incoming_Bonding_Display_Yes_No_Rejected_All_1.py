...
class TC_AD_Bluetooth_1_19_GAP_Dedicated_Incoming_Bonding_Display_Yes_No_Rejected_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Bond devices
        self.SendCommand(ComponentTwo, OpCodes.CREATE_BOND, message=deviceOneAddress)
        ...
        self.SendAndWaitForEvent(ComponentOne, OpCodes.SET_PAIRING_CONFIRMATION, OpCodes.UNBOND_REASON_REMOVED, message='%s;false'%deviceTwoAddress, timeout=10)
        time.sleep(2)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_1_19_GAP_Dedicated_Incoming_Bonding_Display_Yes_No_Rejected_All_1("TC_AD_Bluetooth_1_19_GAP_Dedicated_Incoming_Bonding_Display_Yes_No_Rejected_All_1", duts)
        tc.run()
