...
class TC_AD_Bluetooth_6_26_HFP_Busy_signal_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput("Verify that a busy signal can be heard in the headset. Yes/No", option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_26_HFP_Busy_signal_All_1("TC_AD_Bluetooth_6_26_HFP_Busy_signal_All_1", duts)
        tc.run()
