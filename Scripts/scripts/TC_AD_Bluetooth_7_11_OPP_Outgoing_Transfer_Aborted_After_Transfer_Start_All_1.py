...
class TC_AD_Bluetooth_7_11_OPP_Outgoing_Transfer_Aborted_After_Transfer_Start_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Cancel transfer
        self.Wakeup(ComponentOne, timeout=60)
        self.CancelOngoingTransfer(ComponentOne)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_11_OPP_Outgoing_Transfer_Aborted_After_Transfer_Start_All_1("TC_AD_Bluetooth_7_11_OPP_Outgoing_Transfer_Aborted_After_Transfer_Start_All_1", duts)
        tc.run()
