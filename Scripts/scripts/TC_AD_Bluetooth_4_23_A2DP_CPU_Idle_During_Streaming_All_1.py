...
class TC_AD_Bluetooth_4_23_A2DP_CPU_Idle_During_Streaming_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_23_A2DP_CPU_Idle_During_Streaming_All_1("TC_AD_Bluetooth_4_23_A2DP_CPU_Idle_During_Streaming_All_1", duts)
        tc.run()
