...
class TC_AD_Bluetooth_8_05_PBAP_Incoming_Authentication_Request_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_SSM_BV_07_C'
        ptsSessionPin = '0000'
        ...
        # OBEX authentication
        self.enterPTSSessionKey(ComponentOne, ptsSessionPin)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_05_PBAP_Incoming_Authentication_Request_All_1("TC_AD_Bluetooth_8_05_PBAP_Incoming_Authentication_Request_All_1", duts)
        tc.run()
