...
class TC_AD_Bluetooth_6_32_HFP_Link_Loss_During_Voice_Call_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        #Link loss
        BluetoothDialogInput('Press OK and then walk out of range with the headset. When connection is lost wait for a while then return back and trigger re-connect')
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_32_HFP_Link_Loss_During_Voice_Call_All_1("TC_AD_Bluetooth_6_32_HFP_Link_Loss_During_Voice_Call_All_1", duts)
        tc.run()
