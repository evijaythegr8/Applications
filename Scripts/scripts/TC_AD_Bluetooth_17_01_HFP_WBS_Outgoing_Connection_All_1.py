...
class TC_AD_Bluetooth_17_01_HFP_WBS_Outgoing_Connection_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_01_HFP_WBS_Outgoing_Connection_All_1("TC_AD_Bluetooth_17_01_HFP_WBS_Outgoing_Connection_All_1", duts)
        tc.run()
