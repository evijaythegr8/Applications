...
class TC_AD_Bluetooth_10_09_SAP_Server_SIM_Reset_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTS_TC='TC_SERVER_RST_BV_01_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_10_09_SAP_Server_SIM_Reset_All_1("TC_AD_Bluetooth_10_09_SAP_Server_SIM_Reset_All_1", duts)
        tc.run()
