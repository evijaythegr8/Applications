...
class TC_AD_Bluetooth_6_24_HFP_Cancel_Outgoing_Call_From_HF_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput("Cancel the call from the headset then press Enter.")
        ...
        BluetoothDialogInput("Verify that the call was setup correctly and audio is routed to the headset. Yes/No", option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_24_HFP_Cancel_Outgoing_Call_From_HF_All_1("TC_AD_Bluetooth_6_24_HFP_Cancel_Outgoing_Call_From_HF_All_1", duts)
        tc.run()
