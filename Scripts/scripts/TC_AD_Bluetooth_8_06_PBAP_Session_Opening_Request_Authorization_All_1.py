...
class TC_AD_Bluetooth_8_06_PBAP_Session_Opening_Request_Authorization_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_SSM_BV_08_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_06_PBAP_Session_Opening_Request_Authorization_All_1("TC_AD_Bluetooth_8_06_PBAP_Session_Opening_Request_Authorization_All_1", duts)
        tc.run()
