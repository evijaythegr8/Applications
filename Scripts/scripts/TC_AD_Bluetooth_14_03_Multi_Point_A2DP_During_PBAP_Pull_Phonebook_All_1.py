...
class TC_AD_Bluetooth_14_03_Multi_Point_A2DP_During_PBAP_Pull_Phonebook_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_14_03_Multi_Point_A2DP_During_PBAP_Pull_Phonebook_All_1("TC_AD_Bluetooth_14_03_Multi_Point_A2DP_During_PBAP_Pull_Phonebook_All_1", duts)
        tc.run()
