...
class TC_AD_Bluetooth_12_20_FTP_Push_Large_File_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_SERVER_OTR_BV_14_I'
        ...
        self.WaitForEvent(ComponentOne, OpCodes.ACTION_ACL_DISCONNECTED, timeout=600)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_12_20_FTP_Push_Large_File_All_1("TC_AD_Bluetooth_12_20_FTP_Push_Large_File_All_1", duts)
        tc.run()
