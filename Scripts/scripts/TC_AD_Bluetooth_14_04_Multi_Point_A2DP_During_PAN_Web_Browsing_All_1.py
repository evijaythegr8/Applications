...
class TC_AD_Bluetooth_14_04_Multi_Point_A2DP_During_PAN_Web_Browsing_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput('Verify that you can browse the WEB via the PAN connection, verify that the A2DP sound is playing with good quality', option="TEST")
        time.sleep(5)
        BluetoothDialogInput('Disconnect the PAN connection and verify that the audio is playing with good quality. Yes/No', option="TEST")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_14_04_Multi_Point_A2DP_During_PAN_Web_Browsing_All_1("TC_AD_Bluetooth_14_04_Multi_Point_A2DP_During_PAN_Web_Browsing_All_1", duts)
        tc.run()
