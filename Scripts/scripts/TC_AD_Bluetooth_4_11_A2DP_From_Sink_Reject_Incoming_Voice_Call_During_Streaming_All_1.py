...
class TC_AD_Bluetooth_4_11_A2DP_From_Sink_Reject_Incoming_Voice_Call_During_Streaming_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_11_A2DP_From_Sink_Reject_Incoming_Voice_Call_During_Streaming_All_1("TC_AD_Bluetooth_4_11_A2DP_From_Sink_Reject_Incoming_Voice_Call_During_Streaming_All_1", duts)
        tc.run()
