...
class TC_AD_Bluetooth_6_11_HFP_Reject_Call_From_HF_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        BluetoothDialogInput("Reject call using the headset then press Enter")

        BluetoothDialogInput("Verify that the call was terminated correctly. Yes/No", option="TEST")
        ...
        BluetoothDialogInput("Answer the call using the headset then press Enter")

        BluetoothDialogInput("Verify that the call was setup correctly. Yes/No", option="TEST")

        BluetoothDialogInput("Hang-up the call then press Enter")
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_6_11_HFP_Reject_Call_From_HF_All_1("TC_AD_Bluetooth_6_11_HFP_Reject_Call_From_HF_All_1", duts)
        tc.run()
