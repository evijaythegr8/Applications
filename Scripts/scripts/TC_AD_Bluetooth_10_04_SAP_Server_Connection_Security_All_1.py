...
class TC_AD_Bluetooth_10_04_SAP_Server_Connection_Security_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTS_TC='TC_SERVER_CSU_BV_01_I'
        ...
        pairingVariant = self.acceptIncomingSapPairing(ComponentOne, PTS, pincode, timeout=60)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_10_04_SAP_Server_Connection_Security_All_1("TC_AD_Bluetooth_10_04_SAP_Server_Connection_Security_All_1", duts)
        tc.run()
