...
class TC_AD_Bluetooth_10_01_SAP_Server_Card_Reader_Status_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTS_TC='TC_SERVER_CRS_BV_01_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_10_01_SAP_Server_Card_Reader_Status_All_1("TC_AD_Bluetooth_10_01_SAP_Server_Card_Reader_Status_All_1", duts)
        tc.run()
