...
class TC_AD_Bluetooth_17_32_HFP_WBS_Link_Loss_During_Voice_Call_All_1(BluetoothTestCase):
    ...
    def execute(self):
        ...
        time.sleep(5)
        BluetoothDialogInput('Trigger re-connect from headset, then press Enter')
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_17_32_HFP_WBS_Link_Loss_During_Voice_Call_All_1("TC_AD_Bluetooth_17_32_HFP_WBS_Link_Loss_During_Voice_Call_All_1", duts)
        tc.run()
