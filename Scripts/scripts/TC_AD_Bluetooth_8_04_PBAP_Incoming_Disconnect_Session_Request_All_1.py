...
class TC_AD_Bluetooth_8_04_PBAP_Incoming_Disconnect_Session_Request_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_PSE_SSM_BV_05_C'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_8_04_PBAP_Incoming_Disconnect_Session_Request_All_1("TC_AD_Bluetooth_8_04_PBAP_Incoming_Disconnect_Session_Request_All_1", duts)
        tc.run()
