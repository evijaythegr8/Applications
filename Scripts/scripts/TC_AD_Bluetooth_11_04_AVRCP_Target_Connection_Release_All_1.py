...
class TC_AD_Bluetooth_11_04_AVRCP_Target_Connection_Release_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase='TC_TG_CRC_BV_02_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_04_AVRCP_Target_Connection_Release_All_1("TC_AD_Bluetooth_11_04_AVRCP_Target_Connection_Release_All_1", duts)
        tc.run()
