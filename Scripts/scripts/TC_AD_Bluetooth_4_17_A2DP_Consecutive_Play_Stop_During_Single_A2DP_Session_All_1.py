...
class TC_AD_Bluetooth_4_17_A2DP_Consecutive_Play_Stop_During_Single_A2DP_Session_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_4_17_A2DP_Consecutive_Play_Stop_During_Single_A2DP_Session_All_1("TC_AD_Bluetooth_4_17_A2DP_Consecutive_Play_Stop_During_Single_A2DP_Session_All_1", duts)
        tc.run()
