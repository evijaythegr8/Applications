...
class TC_AD_Bluetooth_5_03_HSP_Incoming_Connection_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ComponentTwo = '2'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_AG_OAC_BV_01_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_5_03_HSP_Incoming_Connection_All_1("TC_AD_Bluetooth_5_03_HSP_Incoming_Connection_All_1", duts)
        tc.run()
