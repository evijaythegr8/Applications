...
class TC_AD_Bluetooth_7_25_OPP_Combined_Power_Managment_During_Outgoing_Transfer_All_1(BluetoothTestCase):
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_7_25_OPP_Combined_Power_Managment_During_Outgoing_Transfer_All_1("TC_AD_Bluetooth_7_25_OPP_Combined_Power_Managment_During_Outgoing_Transfer_All_1", duts)
        tc.run()
