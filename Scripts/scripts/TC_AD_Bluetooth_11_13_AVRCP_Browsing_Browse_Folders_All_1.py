...
class TC_AD_Bluetooth_11_13_AVRCP_Browsing_Browse_Folders_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        ptsAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase_1='TC_TG_CEC_BV_01'
        ptsTestCase_2='TC_TG_MCN_CB_BV_02_I'
        ptsTestCase_3='TC_TG_MCN_CB_BV_03_I'

        self.Components[ComponentOne] = BluetoothTestComponent(self.devices[0],
                                                                apk='BluetoothTestAppEclair.apk',
                                                                package='com.stericsson.test.bluetooth.app',
                                                                activity='MainBluetoothActivity',
                                                                host=devices[0].DeviceConfiguration.Host, port=devices[0].DeviceConfiguration.Port)
        ...
        # Run second PTS test case
        BluetoothDialogInput('Press OK, then start the test case: %s in PTS'%ptsTestCase_3)
        time.sleep(5)
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_11_13_AVRCP_Browsing_Browse_Folders_All_1("TC_AD_Bluetooth_11_13_AVRCP_Browsing_Browse_Folders_All_1", duts)
        tc.run()
