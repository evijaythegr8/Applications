...
class TC_AD_Bluetooth_12_26_FTP_Delete_Non_Empty_Folder_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_SERVER_OMA_BV_07_I'
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_12_26_FTP_Delete_Non_Empty_Folder_All_1("TC_AD_Bluetooth_12_26_FTP_Delete_Non_Empty_Folder_All_1", duts)
        tc.run()
