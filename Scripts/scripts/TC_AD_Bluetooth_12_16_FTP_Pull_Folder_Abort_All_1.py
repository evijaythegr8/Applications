...
class TC_AD_Bluetooth_12_16_FTP_Pull_Folder_Abort_All_1(BluetoothTestCase):

    def execute(self):
        ComponentOne = '1'
        PTSDongleAddress = Session.getSetupFileParam('bt', 'addresspts')
        ptsTestCase = 'TC_SERVER_OTR_BV_09_I'
        ...
        # Create large file
        self.RunShellCommand(ComponentOne, 'dd if=/dev/zero of=/sdcard/sub1/long.txt count=10000')
        time.sleep(10)
        ...
        #Clean up file
        self.RunShellCommand(ComponentOne, 'rm /sdcard/sub1/long.txt')
...
if __name__ == '__main__':
    ...
    if(env.setup()):
        tc = TC_AD_Bluetooth_12_16_FTP_Pull_Folder_Abort_All_1("TC_AD_Bluetooth_12_16_FTP_Pull_Folder_Abort_All_1", duts)
        tc.run()
